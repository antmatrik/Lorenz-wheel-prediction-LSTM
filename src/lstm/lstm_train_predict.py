...
Run from the project root, e.g.:
    ...
    python src/lstm/lstm_train_predict.py --mode train            # full training
    python src/lstm/lstm_train_predict.py --mode train --sanity   # quick check: 1 epoch, 1 file
    python src/lstm/lstm_train_predict.py --mode predict
    python src/lstm/lstm_train_predict.py --help
"""
