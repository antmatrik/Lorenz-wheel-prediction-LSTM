#!/usr/bin/env python3
"""Echo State Network (ESN) forecaster for Lorenz water-wheel CSVs.

Trains a fixed random reservoir with a ridge-regression readout, then rolls the
model forward autoregressively to forecast future points.

Example:
    python src/esn/esn_forecast.py --input data/samples/water_wheel.csv \\
        --steps 300 --output outputs/forecast_esn.csv
"""
import argparse
